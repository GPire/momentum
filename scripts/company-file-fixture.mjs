...
export function companyFileFixture(origin){
  ...
  for(const file of ['schema.sql','reports.sql','attachment-quota.sql','attachment-lifecycle.sql','attachment-journal.sql'])sql.exec(readFileSync(new URL('../server/company/'+file,import.meta.url),'utf8'));
