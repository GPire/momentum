...
ritardo massimo. Permessi e identit� verificate non sono memorizzati in cache.
...
### Vincolo di costo e risparmio identit�
Nessun piano a pagamento o nuovo account attivato. Software di autenticazione
open source gestito da Momentum � una possibilit�, non un servizio completato.
