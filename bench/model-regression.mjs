...
const BASE = { abbonamenti: ['netflix', 'spotify premium', 'disney plus', 'dazn', 'amazon prime', 'now tv', 'apple music', 'youtube premium', 'palestra mensile', 'telepass abbonamento', 'sky broadband uk', 'peacock premium us'], crypto: ['binance acquisto btc', 'coinbase ethereum', 'kraken bitcoin', 'crypto exchange deposito', 'acquisto solana', 'bitpanda crypto', 'wallet btc ricarica', 'etoro crypto trade'], etf: ['acquisto etf msci world', 'vanguard sp500', 'ishares etf global', 'pac etf mensile', 'directa acquisto etf', 'etf obbligazionario acquisto', 'etrade brokerage account'], ristoranti: ['trattoria da mario', 'pizzeria bella napoli', 'sushi bar tokyo', 'ristorante il gambero', 'osteria del corso', 'mcdonalds', 'burger king', 'bar pasticceria centrale', 'kebab house', 'wendys drive thru', 'subway sandwich shop'], shopping: ['zara abbigliamento', 'amazon marketplace', 'h m store', 'mediaworld elettronica', 'decathlon sport', 'zalando ordine', 'ikea mobili', 'sephora profumeria', 'libreria feltrinelli', 'ebay purchase online', 'sears department store'], spesa: ['esselunga supermercato', 'coop alleanza', 'conad city', 'lidl italia', 'carrefour express', 'eurospin', 'pam panorama', 'mercato ortofrutta', 'penny market', 'wegmans grocery store', 'iceland foods uk'], stipendio: ['accredito emolumenti azienda', 'stipendio mensile bonifico', 'salary payment', 'competenze mese corrente', 'bonifico stipendio srl', 'cedolino accredito', 'direct deposit paycheck'], trasporti: ['trenitalia biglietto', 'italo treno', 'atm milano ricarica', 'benzina q8', 'esso carburante', 'autostrade pedaggio', 'uber trip', 'taxi 3570', 'flixbus viaggio', 'megabus coach ticket'],
  casa: ['affitto bilocale centro', 'mutuo prima casa', 'spese condominio scala b', 'agenzia immobiliare toscana', 'idraulico intervento urgente', 'imbianchino preventivo salotto', 'assicurazione abitazione annuale', 'spese notarili acquisto casa', 'zillow rent payment', 'estate agent fee uk'],
  bollette: ['bolletta enel casa', 'fattura fibra vodafone', 'bolletta gas metano', 'ricarica tim mobile', 'bolletta acqua comunale', 'fattura windtre fisso', 'canone rai televisione', 'bolletta riscaldamento centralizzato', 'npower energy bill', 'duke energy bill us'],
  salute: ['farmacia san marco', 'visita dentistica privata', 'analisi del sangue laboratorio', 'fisioterapia post infortunio', 'visita veterinaria cane', 'ottico nuovi occhiali', 'ticket ambulatorio asl', 'clinica dentale controllo', 'rite aid pharmacy us', 'superdrug pharmacy uk'],
  istruzione: ['tasse universita bologna', 'corso inglese online', 'retta asilo nido', 'libri universitari acquisto', 'ripetizioni matematica liceo', 'iscrizione master specialistico', 'corso coursera certificazione', 'scuola guida lezioni pratiche', 'fafsa student aid us', 'pearson course fee'],
  viaggi: ['hotel booking weekend', 'airbnb appartamento vacanza', 'assicurazione viaggio annullamento', 'escursione guidata montagna', 'crociera mediterraneo cabina', 'pacchetto vacanza tutto incluso', 'soggiorno resort mare', 'visto turistico ambasciata', 'delta airlines flight ticket', 'expedia flight booking us'],
  svago: ['cinema multisala biglietto', 'concerto arena biglietto', 'museo egizio ingresso', 'piscina comunale abbonamento', 'bowling serata amici', 'playstation store gioco', 'parco divertimenti gardaland', 'teatro alla scala biglietto', 'six flags theme park', 'cineworld cinema ticket'],
};
