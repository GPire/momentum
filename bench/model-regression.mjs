...
const BASE = { abbonamenti: ['netflix', 'spotify premium', 'disney plus', 'dazn', 'amazon prime', 'now tv', 'apple music', 'youtube premium', 'palestra mensile', 'telepass abbonamento'], crypto: ['binance acquisto btc', 'coinbase ethereum', 'kraken bitcoin', 'crypto exchange deposito', 'acquisto solana', 'bitpanda crypto', 'wallet btc ricarica'], etf: ['acquisto etf msci world', 'vanguard sp500', 'ishares etf global', 'pac etf mensile', 'directa acquisto etf', 'etf obbligazionario acquisto'], ristoranti: ['trattoria da mario', 'pizzeria bella napoli', 'sushi bar tokyo', 'ristorante il gambero', 'osteria del corso', 'mcdonalds', 'burger king', 'bar pasticceria centrale', 'kebab house'], shopping: ['zara abbigliamento', 'amazon marketplace', 'h m store', 'mediaworld elettronica', 'decathlon sport', 'zalando ordine', 'ikea mobili', 'sephora profumeria', 'libreria feltrinelli'], spesa: ['esselunga supermercato', 'coop alleanza', 'conad city', 'lidl italia', 'carrefour express', 'eurospin', 'pam panorama', 'mercato ortofrutta', 'penny market'], stipendio: ['accredito emolumenti azienda', 'stipendio mensile bonifico', 'salary payment', 'competenze mese corrente', 'bonifico stipendio srl', 'cedolino accredito'], trasporti: ['trenitalia biglietto', 'italo treno', 'atm milano ricarica', 'benzina q8', 'esso carburante', 'autostrade pedaggio', 'uber trip', 'taxi 3570', 'flixbus viaggio'],
  casa: ['affitto bilocale centro', 'mutuo prima casa', 'spese condominio scala b', 'agenzia immobiliare toscana', 'idraulico intervento urgente', 'imbianchino preventivo salotto', 'assicurazione abitazione annuale', 'spese notarili acquisto casa'],
  bollette: ['bolletta enel casa', 'fattura fibra vodafone', 'bolletta gas metano', 'ricarica tim mobile', 'bolletta acqua comunale', 'fattura windtre fisso', 'canone rai televisione', 'bolletta riscaldamento centralizzato'],
  salute: ['farmacia san marco', 'visita dentistica privata', 'analisi del sangue laboratorio', 'fisioterapia post infortunio', 'visita veterinaria cane', 'ottico nuovi occhiali', 'ticket ambulatorio asl', 'clinica dentale controllo'],
  istruzione: ['tasse universita bologna', 'corso inglese online', 'retta asilo nido', 'libri universitari acquisto', 'ripetizioni matematica liceo', 'iscrizione master specialistico', 'corso coursera certificazione', 'scuola guida lezioni pratiche'],
  viaggi: ['hotel booking weekend', 'airbnb appartamento vacanza', 'assicurazione viaggio annullamento', 'escursione guidata montagna', 'crociera mediterraneo cabina', 'pacchetto vacanza tutto incluso', 'soggiorno resort mare', 'visto turistico ambasciata'],
  svago: ['cinema multisala biglietto', 'concerto arena biglietto', 'museo egizio ingresso', 'piscina comunale abbonamento', 'bowling serata amici', 'playstation store gioco', 'parco divertimenti gardaland', 'teatro alla scala biglietto'],
};
