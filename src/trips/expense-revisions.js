...
const fields = ['amount', 'description', 'date', 'category', 'tripCategory', 'mealType', 'paymentMethod', 'transportMode', 'receiptImage', 'tripPersonal', 'co2', 'originalAmount', 'originalCurrency', 'exchangeRate'];
