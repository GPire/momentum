...
export function tripReviewSnapshot(trip, transactions) {
  const fields = ['id', 'amount', 'date', 'description', 'category', 'tripCategory', 'mealType', 'paymentMethod', 'transportMode', 'co2', 'currency', 'originalCurrency', 'originalAmount', 'exchangeRate', 'receiptImage', 'tripRevisionConflict'];
