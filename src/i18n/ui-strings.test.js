...
test('t: tutte le chiavi genesis esistono in IT/EN/ES/DE/FR — nessuna traduzione dimenticata', () => {
  const chiavi = [
    ...
    // Sotto-domanda PAESE (2026-09-06): corregge il bug lingua↔Paese fiscale.
    'genesisPivaCountryTitle', 'genesisPivaCountrySub', 'genesisPivaCountryIt', 'genesisPivaCountryEs', 'genesisPivaCountryCh', 'genesisPivaCountryOther',
    ...
    'payoffPivaTitleEs', 'payoffPivaSubEs', 'payoffPivaTitleCh', 'payoffPivaSubCh', 'payoffPivaTitleOther', 'payoffPivaSubOther',
...
test('t: tutte le chiavi f24* esistono in tutte e 7 le lingue', () => {
  const chiavi = [
    ...
    'f24FieldAnno', 'f24FieldImporto', 'f24GuideBack', 'f24GuideNext', 'f24GuideDone', 'f24OpenPortalLink',
  ];
...
test('contextual view choices and task form labels exist in all seven languages', () => {
 for (const lang of UI_LANGS) {
  for (const key of ['viewChoiceIntro','viewEssentialHelp','viewCompleteHelp','viewChoiceNote','debtNameLabel','debtNameExample','debtBalanceLabel','debtRateLabel','debtPaymentLabel','tripNameLabel','tripNameShortExample','simulationHorizon','debtScreenTitle','debtScreenSub','debtEmptyHint','debtRowSummary','debtDeleteBtn','debtAddSectionTitle','debtAddBtn','debtExtraTitle','debtExtraPlaceholder','debtStratAvalancheBtn','debtStratSnowballBtn','debtStratAvalancheLabel','debtStratSnowballLabel','debtOrderTitle','debtFreeFromLabel','debtTotalInterestLabel','debtFormError','debtMotivoInsufficiente','debtMotivoTroppoLungo','debtCompareUnresolvable','debtCompareSameResult','debtCompareDiff','debtBaselineUnresolvable','debtBaselineNoDiff','debtBaselineSaving','debtTypeLabel','debtTypeCard','debtTypeLoan','debtTypeMortgage','debtTypeOther','debtMortgagePenaltyLabel','debtMortgagePenaltyHint','debtPaidOffOn','bankFeesTitle','bankFeesSub','bankFeesBtn','bankFeesModalTitle','bankFeesModalSub','bankFeesEmptyHint','bankFeesTotalLabel','bankFeesCountLabel','bankFeesYearCompare','bankFeesBreakdownTitle','bankFeesStateTaxNote','debtVariableRateLabel','debtVariableRateHint','debtStressTassoTitle','debtStressTassoWarning','debtStressTassoImpact','debtConsolidationTrap','debtConsolidationBetter','debtConsolidationNoDiff','debtConsolidationUnviable','debtConsolidationCurrentUnresolvable','debtConsolidationBtn','debtConsolidationTitle','debtConsolidationSub','debtConsolidationFeeLabel','debtPromoLabel','debtPromoHint','debtPromoUntilLabel','debtPromoRateAfterLabel','debtPromoExpiring','debtPromoExpired','debtPromoImpact','debtPromoUnviable','debtDtiTitle','debtDtiSub','debtDtiUnknownIncome','debtDtiOttimo','debtDtiModerato','debtDtiAttenzione','debtDtiCritico','debtDtiCapacity','debtDtiOverThreshold','debtAdvancedShow','debtAdvancedHide','debtRegisterPaymentBtn','debtRegisterPaymentTitle','debtRegisterPaymentSub','debtRegisterPaymentAmountLabel','debtRegisterPaymentConfirm','debtRegisterPaymentDone','debtRegisterPaymentPaidOff','debtOffersTitle','debtOffersSub','debtOffersAddAnother','debtOffersOfferLabel','debtOffersNameLabel','debtOffersRankTitle','debtOffersBest','debtOffersOnlyViable','debtOffersAllUnviable']) assert.ok(t(key,lang) && t(key,lang)!==key,`${lang}: ${key}`);
