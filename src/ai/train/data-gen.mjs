...
const SUBCAT = {
  assicurazioni: ['polizza assicurativa auto', 'assicurazione rc auto premio', 'premio assicurativo vita',
    ...
    'assicurazione moto rc', 'polizza sanitaria integrativa', 'reale mutua polizza',
    'genertel assicurazione online', 'linear assicurazione auto', 'groupama polizza rata',
    'assicurazione responsabilita civile professionale', 'cattolica assicurazioni premio'],
  ...
  rimborsi: ['rimborso fiscale agenzia entrate', 'rimborso irpef dichiarazione redditi', 'accredito rimborso f24',
    ...
    'rimborso biglietto annullato', 'rimborso spese mediche assicurazione', 'accredito nota di credito',
    'rimborso volo cancellato compagnia', 'restituzione caparra affitto', 'rimborso tassa universitaria',
    'accredito rimborso bolletta', 'rimborso premio assicurativo annullato'],
  scommesse: ['scommessa sportiva online', 'sisal matchpoint giocata', 'snai scommessa calcio',
    ...
    'gratta e vinci acquisto', 'superenalotto giocata', 'lottomatica giocata online',
    'eurobet deposito conto', 'planetwin365 scommessa', 'goldbet giocata sportiva',
    'ricarica conto gioco online', 'puntata scommessa basket'],
  manutenzione: ['riparazione elettrodomestico tecnico', 'assistenza tecnica caldaia intervento', 'manutenzione ascensore condominio',
    ...
    'sostituzione caldaia preventivo', 'intervento antennista tv', 'riparazione perdita tetto',
    'manutenzione impianto allarme', 'pulizia canne fumarie intervento', 'preventivo lavori ristrutturazione',
    'sostituzione serratura porta', 'intervento spurgo fognario', 'manutenzione cancello automatico'],
  animali: ['petshop mangime cane', 'veterinario visita animale', 'toelettatura cane gatto', 'clinica veterinaria intervento',
    ...
    'assicurazione animale domestico', 'accessori animali acquisto', 'vaccinazione veterinaria cane',
    'microchip animale intervento', 'sterilizzazione gatto clinica', 'addestramento cane corso',
    'acquario negozio pesci', 'gabbia uccellino acquisto'],
  alcolici: ['vineria acquisto vino bottiglia', 'cantina vini selezione', 'birreria artigianale bottiglie',
    ...
    'champagneria acquisto bollicine', 'birrificio acquisto casse', 'tannico acquisto vino online',
    'vivino acquisto bottiglia', 'enoteca online spedizione', 'grappa acquisto distilleria',
    'rum invecchiato acquisto', 'gin artigianale bottiglia'],
};
for (const k in SUBCAT) POOL[k] = [...(POOL[k] || []), ...SUBCAT[k]];

// ── ONDATA SUBCAT_INTL (2026-08-30, richiesta esplicita: le 10 categorie
// nuove erano solo in italiano, mentre il resto del pool copre già EU+UK+
// US+Brasile — stessa disciplina applicata qui, brand REALI verificabili
// per Paese, non inventati. ──
const SUBCAT_INTL = {
  assicurazioni: ['allianz direct uk insurance', 'aviva insurance policy', 'axa france assurance',
    'admiral insurance uk', 'geico car insurance', 'statefarm insurance premium', 'progressive insurance us',
    'huk coburg versicherung', 'allianz deutschland versicherung', 'maif assurance france',
    'groupama assurance auto', 'mapfre seguro espana', 'mutua madrilena seguro', 'direct line insurance uk'],
  commissioni: ['n26 fee foreign transaction', 'revolut fee exchange', 'monzo overdraft fee',
    'chase bank fee', 'wells fargo overdraft fee', 'sparkasse kontofuhrung gebuhr',
    'deutsche bank kontogebuhr', 'la banque postale frais', 'caixa comisiones cuenta'],
  trasferimenti: ['internal transfer own account', 'wire transfer own account', 'sepa transfer own account',
    'virement interne compte', 'ueberweisung eigenes konto', 'transferencia entre cuentas propias'],
  regali: ['etsy gift purchase', 'notonthehighstreet gift shop', 'interflora flower delivery',
    'moonpig gift card uk', 'amazon geschenkgutschein', 'cdiscount cadeau anniversaire', 'el corte ingles regalo'],
  professionale: ['legalzoom attorney fee', 'rocket lawyer consultation', 'steuerberater honorar',
    'avocat honoraires conseil', 'gestor asesoria fiscal', 'expert comptable honoraires'],
  rimborsi: ['hmrc tax refund uk', 'irs tax refund us', 'finanzamt erstattung steuer',
    'remboursement impots france', 'hacienda devolucion renta', 'customer service refund order'],
  scommesse: ['williamhill bet deposit', 'ladbrokes bet online', 'betfair deposit account',
    'draftkings deposit us', 'fanduel deposit us', 'tipico wette einzahlung', 'betclic depot compte', 'unibet inzahlung konto'],
  manutenzione: ['handyman service call out', 'plumber emergency callout', 'boiler repair service uk',
    'klempner notdienst reparatur', 'plombier intervention urgence', 'fontanero reparacion urgente'],
  animali: ['petco purchase pet supplies', 'petsmart purchase online', 'vets4pets appointment uk',
    'tierarztpraxis behandlung', 'veterinaire consultation animal', 'veterinario clinica animal'],
  alcolici: ['majestic wine uk purchase', 'bws liquor store purchase', 'total wine purchase us',
    'weinhandlung kauf flasche', 'cave a vin achat', 'bodega vinos compra online'],
};
for (const k in SUBCAT_INTL) POOL[k] = [...(POOL[k] || []), ...SUBCAT_INTL[k]];
